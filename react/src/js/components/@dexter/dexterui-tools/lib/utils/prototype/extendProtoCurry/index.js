...
/**
* @function extendProtoCurry
* @desc a curried function that takes a base and object to extend and shallow
...
var extendProtoCurry = function extendProtoCurry(proto) {
    return function (objToExtend) {
        return [proto, objToExtend].every(isValidObject) ? Object.assign(Object.create(proto), objToExtend) : {};
    };
};
export default extendProtoCurry;